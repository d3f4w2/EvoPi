...
├── docs/evopi-v2/                 # EvoPi 演化数据（灵感池 / 路线图 / ADR）
│                                  #   （演化方法本身 = .claude/skills/evolution-harness/）
...
- 🔄 **持续演化**：项目不是一次性交付。「新输入（文章 / 开源项目 / 灵感 / 架构反思）怎么有序改造项目」的**方法**已固化为通用 skill [`.claude/skills/evolution-harness/`](.claude/skills/evolution-harness/SKILL.md)；EvoPi 自己的**演化数据**（灵感池 / 路线图 / ADR）在 [docs/evopi-v2/](docs/evopi-v2/)。
